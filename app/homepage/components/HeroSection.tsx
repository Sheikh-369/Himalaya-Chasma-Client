...
//         `blur(${progress * 12}px) brightness(${1 - progress * 0.45})`;
...
//       {/* FLOATING CARD */}
//       <div className="absolute top-1/3 right-16 hidden lg:block z-30">
...
//               <AppIcon name="StarIcon" size={16} className="text-white" />
//             </div>

//             <div>
//               <p className="text-white text-sm font-semibold">4.9 / 5.0</p>
//               <p className="text-white/70 text-xs">2,400+ reviews</p>
//             </div>
...
//           Handpicked sunglasses, expert prescription fittings,
//           and same-day repairs — all under one roof.
//         </p>
